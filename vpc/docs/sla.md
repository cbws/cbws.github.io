...
1.  **Plan for Improvement:** CBWS may provide the customer with a plan for improvement to address the cause of the service unavailability.
2.  **Service Credits (Compensation):**
    * **Eligibility:** If the VPC service in a specific Availability Zone is unavailable for at least four (4) continuous hours during a calendar month due to failures within CBWS's responsibility, the customer is eligible to request service credits.
    * **Credit Amount:** Eligible compensation is 10% of the monthly fees paid for the specifically affected VPC service in the impacted AZ for that month. The maximum compensation for any single event or series of related events in a calendar month is capped at €1,000.00.
...
* Issues related to connectivity over the public internet to or from the VPC, which are covered under the Public Networking SLA if Public Networking services are also utilized.
